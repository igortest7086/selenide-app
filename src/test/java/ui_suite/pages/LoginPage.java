...
public class LoginPage extends AbstractPage{
    ...
    {
        $(INPUT_LOGIN).shouldBe(visible, Duration.ofSeconds(10)).sendKeys(user.getUsername());
        $(INPUT_PASSWORD).shouldBe(visible, Duration.ofSeconds(10)).sendKeys(user.getPassword());
        $(SUBMIT_BUTTON).shouldBe(clickable, Duration.ofSeconds(10)).click();
